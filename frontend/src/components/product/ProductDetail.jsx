...
export default function ProductDetail () {
    ...
    useEffect(() => {
        ...
        // Fetch product details only if not already fetched or if the ID changes
        if (!product || product._id !== id) {
            dispatch(getProduct(id));
        }
    
        return () => {
            // Ensure product details persist across navigation
            // dispatch(clearProduct()); ❌ Remove this to prevent clearing when navigating away
        };
