...
var UnstableContext = React.createContext({});
...
var Handles = React3.forwardRef(function(props, ref) {
  ...
  var _React$useState = React3.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), activeVisible = _React$useState2[0], setActiveVisible = _React$useState2[1];
  var _React$useState3 = React3.useState(-1), _React$useState4 = _slicedToArray(_React$useState3, 2), activeIndex = _React$useState4[0], setActiveIndex = _React$useState4[1];
  ...
  }), activeHandleRender && activeVisible && React3.createElement(Handle_default, _extends({
    key: "a11y"
  }, handleProps, {
...
var Mark = function Mark2(props) {
  ...
  var _React$useContext = React4.useContext(context_default), min = _React$useContext.min, max = _React$useContext.max, direction = _React$useContext.direction, includedStart = _React$useContext.includedStart, includedEnd = _React$useContext.includedEnd, included = _React$useContext.included;
...
var Marks = function Marks2(props) {
  ...
  return React5.createElement("div", {
    ...
    return React5.createElement(Mark_default, {
      key: value,
...
var Dot = function Dot2(props) {
  ...
  var _React$useContext = React6.useContext(context_default), min = _React$useContext.min, max = _React$useContext.max, direction = _React$useContext.direction, included = _React$useContext.included, includedStart = _React$useContext.includedStart, includedEnd = _React$useContext.includedEnd;
...
var Steps = function Steps2(props) {
  ...
  var _React$useContext = React7.useContext(context_default), min = _React$useContext.min, max = _React$useContext.max, step = _React$useContext.step;
  var stepDots = React7.useMemo(function() {
  ...
  return React7.createElement("div", {
    ...
    return React7.createElement(Dot_default, {
      prefixCls,
      key: dotValue,
      value: dotValue,
      style,
...
var Track = function Track2(props) {
  ...
  var _React$useContext = React8.useContext(context_default), direction = _React$useContext.direction, min = _React$useContext.min, max = _React$useContext.max, disabled = _React$useContext.disabled, range = _React$useContext.range, classNames3 = _React$useContext.classNames;
...
var Tracks = function Tracks2(props) {
  ...
  var _React$useContext = React9.useContext(context_default), included = _React$useContext.included, range = _React$useContext.range, min = _React$useContext.min, styles = _React$useContext.styles, classNames3 = _React$useContext.classNames;
  ...
  var tracksNode = trackList !== null && trackList !== void 0 && trackList.length && (classNames3.tracks || styles.tracks) ? React9.createElement(Track_default, {
    index: null,
    prefixCls,
  ...
  return React9.createElement(React9.Fragment, null, tracksNode, trackList.map(function(_ref, index) {
    var start = _ref.start, end = _ref.end;
    return React9.createElement(Track_default, {
      index,
      prefixCls,
...
function useDrag(containerRef, direction, rawValues, min, max, formatValue, triggerChange, finishChange, offsetValues, editable, minCount) {
  var _React$useState = React10.useState(null), _React$useState2 = _slicedToArray(_React$useState, 2), draggingValue = _React$useState2[0], setDraggingValue = _React$useState2[1];
  var _React$useState3 = React10.useState(-1), _React$useState4 = _slicedToArray(_React$useState3, 2), draggingIndex = _React$useState4[0], setDraggingIndex = _React$useState4[1];
  var _React$useState5 = React10.useState(false), _React$useState6 = _slicedToArray(_React$useState5, 2), draggingDelete = _React$useState6[0], setDraggingDelete = _React$useState6[1];
  var _React$useState7 = React10.useState(rawValues), _React$useState8 = _slicedToArray(_React$useState7, 2), cacheValues = _React$useState8[0], setCacheValues = _React$useState8[1];
  var _React$useState9 = React10.useState(rawValues), _React$useState10 = _slicedToArray(_React$useState9, 2), originValues = _React$useState10[0], setOriginValues = _React$useState10[1];
  var mouseMoveEventRef = React10.useRef(null);
  var mouseUpEventRef = React10.useRef(null);
  var touchEventTargetRef = React10.useRef(null);
  var _React$useContext = React10.useContext(UnstableContext), onDragStart = _React$useContext.onDragStart, onDragChange = _React$useContext.onDragChange;
  ...
  var returnValues = React10.useMemo(function() {
...
var Slider = React12.forwardRef(function(props, ref) {
  ...
  var handlesRef = React12.useRef(null);
  ...
  }), track !== false && React12.createElement(Tracks_default, {
    prefixCls,
    style: trackStyle,
    values: rawValues,
    startPoint,
    onStartMove: mergedDraggableTrack ? onStartMove : void 0
  }), React12.createElement(Steps_default, {
    prefixCls,
    marks: markList,
    dots,
    style: dotStyle,
  ...
  }), React12.createElement(Marks_default, {
    prefixCls,
    marks: markList,
